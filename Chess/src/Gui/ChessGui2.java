...
//					Fen _startFen = Fen.select("rnbqkbn1/pppppppP/8/8/8/8/PPPPPPPp/RNBQKBN1 w KQkq - 0 1");
	...
	private void setFigurWurdeGeschlagenLabel()
	{
		 ...
		 * WEI�   -> 5 = Bauer | 6 = Rook | 7 = Knight | 8 = Bishop | 9 = Queen
		 * Aktuell wird dabei nicht nachvollzogen ob es z.B. der linke oder rechte Turm ist, der geschlagen wurde. 
		 * Es wird dabei immer von links aufgef�llt.
		 * 
		 * Ben�tigt werden 8 int Klassen Variablen b, n, r, p, B, N, R, P, da diese nicht in der Methode jedes mal neu initialisiert werden d�rfen.
		 ...
		 * Ist der Fall. Also n�chste Fallunterscheidung zwischen 4 | 3 | 2 | 1 | 0
		 * 3 ist es, also wird _geschlageneBackFiguren an der Stelle 10 aufgerufen, da dies der RuhePlatz eines Bishop ist.
		 * Dieses Label wird sichtbar gemacht und die Klassenvariable b um 3 erh�ht, da dort der n�chste Ruheplatz eines Bishops ist. 
		 * 
