...
public class ChessGui_old extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChessGui_old frame = new ChessGui_old();
...
//	}
	...
	private void createButtons() {
		...
		btnNewButton.setSelectedIcon(new ImageIcon(ChessGui_old.class.getResource("/Piece_Images/Black_Rook.png")));
